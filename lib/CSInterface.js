...
function HostCapabilities(EXTENDED_PANEL_MENU, EXTENDED_PANEL_ICONS, DELEGATE_APE_ENGINE,
...
CSInterface.prototype.initResourceBundle = function() {
    ...
    for (var n = 0; n < resElms.length; n++) {
        ...
        if (resKey) {
            var resValue = resourceBundle[resKey];
            if (resValue) {
...
CSInterface.prototype.updatePanelMenuItem = function(menuItemLabel, enabled, checked) {
    ...
    window.__adobe_cep__.invokeSync("updatePanelMenuItem", JSON.stringify(itemStatus));
};
...
CSInterface.prototype.isWindowVisible = function() {
    return window.__adobe_cep__.invokeSync("cyclic", "cyclic");
};
